...
if (isset($_GET['id'])!='') {
  ...
  $search="SELECT Title,Description,Link,Tag,CourseID,TermID,SessionID,CreationDate,ProjectDate FROM tbl_project WHERE ID='$id'";
...
<div id="form">
      ...
      <table width="100%" border="1" cellpadding="15" bgcolor=" #d9b3ff">
        ...
        <tr>
          <td>
               <select id="select" type="text" name="CourseID" value="<?php echo $CourseID ?>" >
               <option value="<?php echo $CourseID ?>">Course ID</option>
        ...
        <tr>
          <td >
           ...
           <option value="<?php echo $TermID ?>">Term ID</option>
        ...
        <tr>
          <td>
            ...
            <select id="select" type="text" name="SessionID" >
                ...
                <option value="<?php echo $SessionID ?>">Session ID</option>
             <?php
